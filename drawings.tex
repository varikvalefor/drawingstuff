...
\section{Faults}
Some men find that the clothing whose wearing is depicted by ``HOLLYWOODFREAKSONTHEHOLLYWOODSCENE'' resembles paper.
...
Some men claim that ``THROWTHOSEPICTURESDOWNTHELANE'' depicts VUNC's taking a static, ``robotic'' pose.  VARIK somewhat agrees with the aforementioned claim\ldots but asserts that the ``robotic'' pose of VUNC can be a joke regarding some men's tendency to jokingly claim that VARIK is a robot.
\end{document}
